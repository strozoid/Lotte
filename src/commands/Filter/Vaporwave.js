...
export default class {
    constructor() {
        this.name = ["vaporwave"];
        this.description = "Turning on vaporwave filter";
        this.category = "Filter";
        this.accessableby = [Accessableby.Member];
        this.usage = "";
        this.aliases = ["vaporwave"];
        this.lavalink = true;
        this.options = [];
    ...
    execute(client, handler) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            player === null || player === void 0 ? void 0 : player.filter.set("vaporwave");
            const vaporwaved = new EmbedBuilder()
                .setDescription(`${client.i18n.get(handler.language, "command.filter", "filter_on", {
                name: this.name[0],
            })}`)
                .setColor(client.color);
            yield handler.editReply({ content: " ", embeds: [vaporwaved] });
        });
    }
}
