...
export default class {
    constructor() {
        this.name = ["vibrate"];
        this.description = "Turning on vibrate filter";
        this.category = "Filter";
        this.accessableby = [Accessableby.Member];
        this.usage = "";
        this.aliases = ["vibrate"];
        this.lavalink = true;
        this.options = [];
    ...
    execute(client, handler) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            player === null || player === void 0 ? void 0 : player.filter.setVibrato({
                frequency: 4.0,
                depth: 0.75,
            });
            player === null || player === void 0 ? void 0 : player.filter.setTremolo({
                frequency: 4.0,
                depth: 0.75,
            });
