    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.channel) {
                ...
                const is247 = yield this.client.db.autoreconnect.get(`${this.player.guildId}`);
                yield this.player.stop(is247 && is247.twentyfourseven ? false : true);
                yield this.client.UpdateMusic(this.player);
