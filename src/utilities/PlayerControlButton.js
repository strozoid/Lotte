...
const playerRowOne = (client) => new ActionRowBuilder().addComponents([
    new ButtonBuilder()
        .setCustomId("loop")
...
const playerRowTwo = (client) => new ActionRowBuilder().addComponents([
    new ButtonBuilder()
        .setCustomId("shuffle")
...
const playerRowOneEdited = (client) => new ActionRowBuilder().addComponents([
    new ButtonBuilder()
        .setCustomId("loop")
        .setEmoji(client.config.emojis.PLAYER.loop)
        .setStyle(ButtonStyle.Secondary),
...
const filterSelect = (client) => new ActionRowBuilder().addComponents(new StringSelectMenuBuilder()
    .setCustomId("filter")
